...
const navItems = [
  ...
  { icon: ShoppingCart, label: "Cart", id: "cart", path: "/cart", badge: 3 },
...
export function BottomNavigation() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-gray-200/50 z-50 shadow-[0_-2px_8px_rgba(0,0,0,0.05)]">
      <div className="flex justify-around items-center h-20 max-w-lg mx-auto py-2">
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`relative flex flex-col items-center justify-center p-4 transition-all duration-300 ease-in-out group ${
